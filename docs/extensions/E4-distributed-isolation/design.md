...
**Source:** ROADMAP §6a-E4, `requirements.md`, `survey/dbms-testing-ecosystem.md` §6
...
*단일노드 축 4* (PostgreSQL `.spec` + Hermitage) 는 본 모듈 외 — 기존 `analysis/isolation` 의 strangler-fig 1차 대체 (ADR-004) 검토 시 결정.
