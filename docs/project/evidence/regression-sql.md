...
```bash
docs/project/evidence/sql/sandbox.sh refresh <a CUBRID install built at upstream develop>
SANDBOX=/data/cub_sys/projects/regr-sql docs/project/evidence/sql/baseline.sh     # CTP's side
SANDBOX=/data/cub_sys/projects/regr-sql docs/project/evidence/sql/gate.sh <testkit>   # sqlsuite's, and the comparison
```
