...
docs/project/evidence/sql/sandbox.sh refresh <that install.out>   # lays the sandbox down, then checks it
docs/project/evidence/sql/baseline.sh                              # checks, runs everything, checks again
python3 docs/project/evidence/sql/census.py $SANDBOX/cubrid-testcases                        # §5
python3 docs/project/evidence/sql/selfcheck.py $SANDBOX/sql-1.out $SANDBOX/sql-2.out <root-1> <root-2>   # §6
JAVA_HOME=/usr/lib/jvm/java-8-openjdk-amd64 docs/project/evidence/sql/spike/spike.sh              # §9
```
